...
export default function CertificatePage() {
  ...
  const [visibleItems, setVisibleItems] = useState<
    Record<
      "Codepolitan" | "Dicoding" | "MySkill" | "Ruangguru" | "BNSP",
      number
    >
  >({
    Codepolitan: 6,
  ...
  return (
    <>
      <SEO
        title="Certificates"
        description="Professional certifications and achievements of Muhammad Mifta in web development, programming, and technology."
        url="https://miv.best/certificate"
      />
        ...
        <Tabs defaultValue="codepolitan" className="w-full">
          <div className="flex justify-center">
            <TabsList className="justify-between flex-wrap w-3/4 mx-auto my-10 text-neutral-300">
              {["Codepolitan", "Dicoding", "MySkill", "Ruangguru", "BNSP"].map(
                (tab) => (
                  <TabsTrigger
                    className="group"
