...
export default function AboutLayout() {
  ...
  return (
    <div className="py-20">
      ...
      <div className="px-36 mt-2 flex gap-4">
        <div className="text-gray-200 font-light font-poppins bg-[#272729] p-4 border border-gray-500 rounded-xl w-fit">
          <GithubCalendar username="MuhammadMiftaa" />
        </div>
        <div className="flex flex-col bg-[#272729] border border-gray-500 rounded-xl justify-around items-center w-full content-center">
          <div className="flex flex-col items-center cursor-pointer">
            ...
            <h1 className="font-urbanist text-gray-300 text-[0.6rem] font-light">Codewars</h1>
          </div>
          <div className="flex flex-col items-center cursor-pointer">
            <Image
              ...
              height={60}
            />
            <h1 className="font-urbanist text-gray-300 text-[0.6rem] font-light">Leetcode</h1>
          </div>
        </div>
      </div>
    </div>
