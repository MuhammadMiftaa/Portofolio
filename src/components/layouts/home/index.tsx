  ...
  return (
    <div className="pt-64 flex flex-col w-full h-screen" id="home">
      <div className="flex flex-col w-full items-center px-20">
        <h1 className="text-left text-lg sm:text-4xl md:text-6xl font-poppins w-fit pointer-events-none z-10 h-full whitespace-pre-wrap bg-gradient-to-br from-[#ff2975] from-35% to-[#00FFF1] bg-clip-text font-semibold leading-none tracking-tighter text-transparent dark:drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
          Hello, I'm
        </h1>
        <GradualSpacing
          className="font-display text-center text-xl sm:text-5xl md:text-7xl font-bold -tracking-[0.2em] sm:-tracking-[0.12em] md:-tracking-widest text-white md:leading-[5rem] text-wrap"
