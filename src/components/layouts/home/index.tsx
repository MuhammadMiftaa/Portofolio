...
export default function HomeLayout() {
  return (
    <div className="pt-64 flex flex-col w-full">
      ...
      {/* <VelocityScroll
        ...
        default_velocity={5}
        className="font-display mt-32 font-urbanist text-center text-4xl font-bold tracking-[-0.02em] drop-shadow-sm text-white w-fit md:text-7xl md:leading-[5rem]"
      /> */}
    </div>
  );
}
